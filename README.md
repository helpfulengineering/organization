...
Each project can host a repository under this organization, using the same name as its Slack channel (in [kebab-case](https://en.wiktionary.org/wiki/kebab_case)). **Let us know your needs by opening an issue or pinging any of the [organization members](https://github.com/orgs/helpfulengineering/people) though Slack.**
